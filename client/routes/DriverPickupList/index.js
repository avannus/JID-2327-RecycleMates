...
function DriverPickupList() {
  ...
  return (
    <View style={styles.container}>
      ...
      <Button
        title={'Schedule Option 1: Mon 12-5pm'}
        onPress={createTwoButtonAlert}
      />
      <Button
        title={'Schedule Option 2: Tue 12-5pm'}
        onPress={createTwoButtonAlert}
      />
      <Button
        title={'Schedule Option 3: Thurs 3-6pm'}
        onPress={createTwoButtonAlert}
      />
      <Button
        title={'Schedule Option 4: Sat 8-11am'}
        onPress={createTwoButtonAlert}
      />
    </View>
  );
